<template>
	<nav>
		<ul>
			...
			<li><button><i class="fa fa-reply"></i></button></li>
			...
			<li><button @click='redirect("")'><i class="fa fa-github"></i></button></li>
			<li><button @click='redirect("")'><i class="fa fa-question"></i></button></li>
		</ul>
	</nav>
</template>
